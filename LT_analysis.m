...
Chip = 'chip2_' %XXX
Image = 'collagen 2.5um 1hz fwd.txt' %XXX
Duration = 180

FILE = strcat(Image)

FILEPATH= '/Users/bnm10/Dropbox/Imperial College London/Cass Group/Experiments/2013/23-04-2013 AFM with the DPN/Collagen coated'
...
% 2. Plot 2-d surface plot of topography and locate the locally thinned region
